...
**Output Goal**: 
- 更新 `.antigravity/genesis/v{N}/05_TASKS.md` (仅修改已有任务)
- 更新 `.antigravity/genesis/v{N}/06_CHANGELOG.md`
- (可选) 微调 `.antigravity/genesis/v{N}/04_SYSTEM_DESIGN/` 中已有文件的细节
...
1.  **修改任务清单**:
    使用宿主支持的安全编辑方式修改 `{TARGET_DIR}/05_TASKS.md` 中的对应任务
