...
**Output Goal**: `.vibe/genesis/v{N}/04_SYSTEM_DESIGN/{system-id}.md`
</phase_context>
...
**检查**:
- [ ] `.vibe/genesis/v{N}/01_PRD.md` 存在
- [ ] `.vibe/genesis/v{N}/02_ARCHITECTURE_OVERVIEW.md` 存在
- [ ] `.vibe/genesis/v{N}/03_ADR/` 存在
...
读取 `.vibe/genesis/v{N}/02_ARCHITECTURE_OVERVIEW.md`
...
### 1.4 查找该系统的详细定义
在 `.vibe/genesis/v{N}/02_ARCHITECTURE_OVERVIEW.md` 中搜索 system-id 相关内容
...
读取 `.vibe/genesis/v{N}/03_ADR/ADR_001_TECH_STACK.md`
...
**产出**:
- 调研报告自动保存到: `.vibe/genesis/v{N}/04_SYSTEM_DESIGN/_research/{system-id}-research.md`
...
**加载 L0 模板**（必须）:
读取 `.agents/skills/system-designer/references/system-design-template.md`

**加载 L1 模板**（如果 5.0 决策为「需要」）:
读取 `.agents/skills/system-designer/references/system-design-detail-template.md`
...
**保存 L0 文件**（必须）:
将内容保存到 `.vibe/genesis/v{N}/04_SYSTEM_DESIGN/{system-id}.md`

**保存 L1 文件**（如果 5.0 决策为「需要」）:
将内容保存到 `.vibe/genesis/v{N}/04_SYSTEM_DESIGN/{system-id}.detail.md`

**示例路径**:
- L0: `.vibe/genesis/v{N}/04_SYSTEM_DESIGN/core.md`
- L1: `.vibe/genesis/v{N}/04_SYSTEM_DESIGN/core.detail.md`
...
**调用方式**:
```
/challenge .vibe/genesis/v{N}/04_SYSTEM_DESIGN/{system-id}.md
```
...
```
✅ 系统设计文档已生成:
  - 文件: .vibe/genesis/v{N}/04_SYSTEM_DESIGN/{system-id}.md
  - 调研: .vibe/genesis/v{N}/04_SYSTEM_DESIGN/_research/{system-id}-research.md
...
```markdown
### 系统边界
- {system-id}: {一句话职责} — 详细设计见 `.vibe/genesis/v{N}/04_SYSTEM_DESIGN/{system-id}.md`
```
