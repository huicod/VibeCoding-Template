...
function rewriteGeneratedText(content) {
  return [
    ...
    [/.antigravity\/workflows\b/g, '.agents/workflows'],
    [/.antigravity\/skills\b/g, '.agents/skills'],
    [/.antigravity\/scripts\b/g, '.agents/scripts'],
    [/.vibe\/workflows\b/g, '.agents/workflows'],
    [/.vibe\/skills\b/g, '.agents/skills'],
    [/.vibe\/scripts\b/g, '.agents/scripts'],
    [/.vct\/workflows\b/g, '.agents/workflows'],
    [/.vct\/skills\b/g, '.agents/skills'],
    [/.vct\/scripts\b/g, '.agents/scripts'],
    [/.antigravity\//g, '.vibe/'],
